...
import com.example.android.bluetoothlegatt.communication.MessageService;
...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        try {
            ...
            Double[] bogusData = {heartRate_send};
            message.setData(Arrays.asList(bogusData));
            message.setPerson(myUUID);
    ...
    public boolean connect(final String address) {
        ...
        final BluetoothDevice device = mBluetoothAdapter.getRemoteDevice("E9:65:A4:0B:11:B3");
        if (device == null) {
